...
const { BN_S, BN_M, BN_L, BN_XL, name1Bytes32, infiniteApproval, name2Bytes32 } = require("./constants");
...
describe("GameFactory", function () {
  ...
  before(async function () {
    [deployer, addr1, addr2, addr3, addr4, addr5, _] = await ethers.getSigners();
  ...
  describe("Game", function () {
    ...
    it("Should ditribute weekly reward accordingly", async function () {
      ...
      await testL3P.approve(game.address, infiniteApproval);
